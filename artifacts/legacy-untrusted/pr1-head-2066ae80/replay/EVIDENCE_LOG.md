...
> [!NOTE]
> Evidence level `replay_integration` results represent rigorous validation within this test environment. Synthetic simulations must not be conflated with empirical live network validation.
...
|---|---|---|---|---|---|---|---|
| W1 | W1: Independent fan-out reads | 4439.6ms | 2438.9ms | 1.82x | 45.1% | ✅ PASS | `replay_integration` |
| W2 | W2: Deterministic dependent chains | 6372.4ms | 4820.5ms | 1.32x | 24.4% | ✅ PASS | `replay_integration` |
| W3 | W3: Branching workflows | 2206.2ms | 1776.4ms | 1.24x | 19.5% | ✅ PASS | `replay_integration` |
| W4 | W4: Repeated workflows with plan locality | 6031.6ms | 3476.5ms | 1.73x | 42.4% | ✅ PASS | `replay_integration` |
| W5 | W5: Large tool arguments and results | 2577.8ms | 1862.1ms | 1.38x | 27.8% | ✅ PASS | `replay_integration` |
| W6 | W6: Cold-start code/browser sandboxes | 4262.1ms | 2413.8ms | 1.77x | 43.4% | ✅ PASS | `replay_integration` |
| W7 | W7: Side-effecting actions requiring approval | 2196.1ms | 1967.3ms | 1.12x | 10.4% | ✅ PASS | `replay_integration` |
